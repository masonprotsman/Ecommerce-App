      ...
      {isOpen && (
        <div className='md:hidden bg-slate-900/95 backdrop-blur-lg border-t border-slate-800 animate-in slide-in-from-top duration-300'>
          <div className='px-4 py-4 sm:py-6 space-y-3 sm:space-y-4'>
            <a href='#features' onClick={() => setIsOpen(false)} className='block text-gray-300 hover:text-white text-sm lg:text-base'>Features</a>
            <a href='#pricing' onClick={() => setIsOpen(false)} className='block text-gray-300 hover:text-white text-sm lg:text-base'>Pricing</a>
            <a href='#testimonials' onClick={() => setIsOpen(false)} className='block text-gray-300 hover:text-white text-sm lg:text-base'>Testimonials</a>
          </div>
        </div>
      )}
    </nav>
